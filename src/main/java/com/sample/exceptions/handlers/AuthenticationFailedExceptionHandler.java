...
@Requires(classes = {AuthenticationFailedException.class, ExceptionHandler.class})
public class AuthenticationFailedExceptionHandler
        implements ExceptionHandler<AuthenticationFailedException, HttpResponse> {
    ...
    @Override
    public HttpResponse handle(HttpRequest request, AuthenticationFailedException exception) {
        logger.debug(
